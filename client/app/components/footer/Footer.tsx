        ...
        <CenterDiv>
            <div className={style.main__container}>
                ...
                <div className={style.powered}>
                    ...
                    <a href='https://www.neuroexperience.com.ar/' target='_blank' rel='noreferrer'>
                        <span>Powered by <strong>NEURO STUDIO</strong>.</span>
                    </a>
                    </div>
                    <div className={style.social__container}>
                        <a href='https://www.instagram.com/lylautomotores_/' target='_blank' rel='noreferrer'>
                            <AiFillInstagram/>
                        </a>
                        <IoLogoWhatsapp/>
                    </div>
